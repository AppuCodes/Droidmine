...
public class SoundManager
{
    ...
    public SoundManager(SoundHandler p_i45119_1_, GameOptions p_i45119_2_)
    {
        ...
        {
            logger.error((String)"Error linking with the LibraryJavaSound plug-in", (Throwable)soundsystemexception);
        }
    }
...
//                                }
            ...
            {
                logger.error((String)"Error starting SoundSystem. Turning off sounds & music", (Throwable)runtimeexception);
        ...
        URLStreamHandler urlStreamHandler = new URLStreamHandler()
        {
            protected URLConnection openConnection(final URL p_openConnection_1_)
            {
                return new URLConnection(p_openConnection_1_)
                {
                    ...
                    {
                        return ClientEngine.get().getResourceManager().getResource(p_148612_0_).getInputStream();
                    }
