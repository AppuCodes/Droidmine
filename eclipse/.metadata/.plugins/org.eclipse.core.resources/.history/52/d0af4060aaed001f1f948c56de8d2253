...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    private static final ResourceLocation blueApple = new ResourceLocation("textures/client/apple.png");
    private static final ResourceLocation redApple = new ResourceLocation("textures/items/apple.png");
    ...
    public void initGui()
    {
        ...
        if (this.mc.isDemo())
        {
            this.addDemoButtons(j + 24, 24);
        }
        else
        {
            this.addSingleplayerMultiplayerButtons(j + 24, 24);
        }
