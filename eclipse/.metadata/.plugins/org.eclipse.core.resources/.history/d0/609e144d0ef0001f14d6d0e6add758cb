...
public class GuiOptionSlider extends GuiButton
{
    ...
    public GuiOptionSlider(int p_i45016_1_, int p_i45016_2_, int p_i45016_3_, GameOptions.Options p_i45016_4_)
    {
        this(p_i45016_1_, p_i45016_2_, p_i45016_3_, p_i45016_4_, 0.0F, 1.0F);
    }

    public GuiOptionSlider(int p_i45017_1_, int p_i45017_2_, int p_i45017_3_, GameOptions.Options p_i45017_4_, float p_i45017_5_, float p_i45017_6_)
    {
