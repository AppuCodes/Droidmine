...
public class PlayerMenuObject implements ISpectatorMenuObject
{
    ...
    {
        ClientEngine.get().getNetHandler().sendPacket(new C18PacketSpectate(this.profile.getId()));
    }
    ...
    {
        ClientEngine.get().getTextureManager().bindTexture(this.resourceLocation);
