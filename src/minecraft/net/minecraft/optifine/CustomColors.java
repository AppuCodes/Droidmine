...
public class CustomColors
{
    ...
    public static void update(ClientEngine mc)
    {
        ...
        textColors = null;
        setMapColors(mapColorsOriginal, mc);
        potionColors = null;
        ...
        if (Config.get().isCustomColors())
        {
            ...
            readColorProperties("mcpatcher/color.properties", mc);
    ...
    private static void readColorProperties(String p_readColorProperties_0_, ClientEngine mc)
    {
        try
        {
    ...
    public static Vec3 getWorldFogColor(Vec3 p_getWorldFogColor_0_, WorldClient p_getWorldFogColor_1_, Entity p_getWorldFogColor_2_, float p_getWorldFogColor_3_, ClientEngine mc)
    {
        ...
        switch (i)
        {
            ...
            case 0:
                p_getWorldFogColor_0_ = getFogColor(p_getWorldFogColor_0_, mc.world, p_getWorldFogColor_2_.posX, p_getWorldFogColor_2_.posY + 1.0D, p_getWorldFogColor_2_.posZ);
                break;
    ...
    public static Vec3 getWorldSkyColor(Vec3 p_getWorldSkyColor_0_, World p_getWorldSkyColor_1_, Entity p_getWorldSkyColor_2_, float p_getWorldSkyColor_3_, ClientEngine mc)
    {
        ...
        {
            case 0:
                p_getWorldSkyColor_0_ = getSkyColor(p_getWorldSkyColor_0_, mc.world, p_getWorldSkyColor_2_.posX, p_getWorldSkyColor_2_.posY + 1.0D, p_getWorldSkyColor_2_.posZ);
                break;
    ...
    private static void setMapColors(int[] p_setMapColors_0_, ClientEngine minecraft)
    {
        if (p_setMapColors_0_ != null)
        {
            ...
            if (flag)
            {
                minecraft.getTextureManager().reloadBannerTextures();
            }
        }
    }
