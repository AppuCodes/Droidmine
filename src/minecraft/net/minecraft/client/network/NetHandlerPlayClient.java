...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
     ...
     */
    private ClientEngine gameController;
    ...
    public NetHandlerPlayClient(ClientEngine mcIn, GuiScreen p_i46300_2_, NetworkManager p_i46300_3_, GameProfile p_i46300_4_)
    {
    ...
    public void handleConfirmTransaction(S32PacketConfirmTransaction packetIn)
    {
        ...
        {
            this.sendPacket(new C0FPacketConfirmTransaction(packetIn.getWindowId(), packetIn.getActionNumber(), true));
        }
    }
