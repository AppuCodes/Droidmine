...
public class EntityHugeExplodeFX extends EntityFX
{
    ...
    protected EntityHugeExplodeFX(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double p_i1214_8_, double p_i1214_10_, double p_i1214_12_, ClientEngine mc)
    {
    ...
    public static class Factory implements IParticleFactory
    {
        ...
        {
            return new EntityHugeExplodeFX(worldIn, xCoordIn, yCoordIn, zCoordIn, xSpeedIn, ySpeedIn, zSpeedIn, mc);
        }
    }
}
