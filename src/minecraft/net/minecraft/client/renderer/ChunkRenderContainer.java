...
public abstract class ChunkRenderContainer
{
    ...
    public void preRenderChunk(RenderChunk renderChunkIn)
    {
        ...
        GlStateManager.get().translate((float)((double)blockpos.getX() - this.viewEntityX), (float)((double)blockpos.getY() - this.viewEntityY), (float)((double)blockpos.getZ() - this.viewEntityZ));
    }
