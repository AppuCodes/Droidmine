...
import net.minecraft.optifine.PlayerItemsLayer;
...
public class RenderManager
{
    ...
    public RenderManager(TextureManager renderEngineIn, RenderItem itemRendererIn, ClientEngine mc)
    {
        ...
        this.entityRenderMap.put(EntityPig.class, new RenderPig(this, new ModelPig(), 0.7F, mc));
        this.entityRenderMap.put(EntitySheep.class, new RenderSheep(this, new ModelSheep2(), 0.7F, mc));
        this.entityRenderMap.put(EntityCow.class, new RenderCow(this, new ModelCow(), 0.7F, mc));
        this.entityRenderMap.put(EntityMooshroom.class, new RenderMooshroom(this, new ModelCow(), 0.7F, mc));
        this.entityRenderMap.put(EntityWolf.class, new RenderWolf(this, new ModelWolf(), 0.5F, mc));
        this.entityRenderMap.put(EntityChicken.class, new RenderChicken(this, new ModelChicken(), 0.3F, mc));
        this.entityRenderMap.put(EntityOcelot.class, new RenderOcelot(this, new ModelOcelot(), 0.4F, mc));
        this.entityRenderMap.put(EntityRabbit.class, new RenderRabbit(this, new ModelRabbit(), 0.3F, mc));
        this.entityRenderMap.put(EntitySilverfish.class, new RenderSilverfish(this, mc));
        this.entityRenderMap.put(EntityEndermite.class, new RenderEndermite(this, mc));
        this.entityRenderMap.put(EntityCreeper.class, new RenderCreeper(this, mc));
        this.entityRenderMap.put(EntityEnderman.class, new RenderEnderman(this, mc));
        this.entityRenderMap.put(EntitySnowman.class, new RenderSnowMan(this, mc));
        this.entityRenderMap.put(EntitySkeleton.class, new RenderSkeleton(this, mc));
        this.entityRenderMap.put(EntityWitch.class, new RenderWitch(this, mc));
        this.entityRenderMap.put(EntityBlaze.class, new RenderBlaze(this, mc));
        this.entityRenderMap.put(EntityPigZombie.class, new RenderPigZombie(this, mc));
        this.entityRenderMap.put(EntityZombie.class, new RenderZombie(this, mc));
        this.entityRenderMap.put(EntitySlime.class, new RenderSlime(this, new ModelSlime(16), 0.25F, mc));
        this.entityRenderMap.put(EntityMagmaCube.class, new RenderMagmaCube(this, mc));
        this.entityRenderMap.put(EntityGiantZombie.class, new RenderGiantZombie(this, new ModelZombie(), 0.5F, 6.0F, mc));
        this.entityRenderMap.put(EntityGhast.class, new RenderGhast(this, mc));
        this.entityRenderMap.put(EntitySquid.class, new RenderSquid(this, new ModelSquid(), 0.7F, mc));
        this.entityRenderMap.put(EntityVillager.class, new RenderVillager(this, mc));
        this.entityRenderMap.put(EntityIronGolem.class, new RenderIronGolem(this, mc));
        this.entityRenderMap.put(EntityBat.class, new RenderBat(this, mc));
        this.entityRenderMap.put(EntityGuardian.class, new RenderGuardian(this, mc));
        this.entityRenderMap.put(EntityDragon.class, new RenderDragon(this, mc));
        this.entityRenderMap.put(EntityEnderCrystal.class, new RenderEnderCrystal(this));
        this.entityRenderMap.put(EntityWither.class, new RenderWither(this, mc));
        this.entityRenderMap.put(Entity.class, new RenderEntity(this));
        this.entityRenderMap.put(EntityPainting.class, new RenderPainting(this));
        this.entityRenderMap.put(EntityItemFrame.class, new RenderItemFrame(this, itemRendererIn, mc));
        ...
        this.entityRenderMap.put(EntityArmorStand.class, new ArmorStandRenderer(this, mc));
        this.entityRenderMap.put(EntityMinecartTNT.class, new RenderTntMinecart(this));
        this.entityRenderMap.put(EntityMinecartMobSpawner.class, new RenderMinecartMobSpawner(this));
        this.entityRenderMap.put(EntityMinecart.class, new RenderMinecart(this));
        this.entityRenderMap.put(EntityBoat.class, new RenderBoat(this));
        this.entityRenderMap.put(EntityFishHook.class, new RenderFish(this));
        this.entityRenderMap.put(EntityHorse.class, new RenderHorse(this, new ModelHorse(), 0.75F, mc));
    ...
    private void renderDebugBoundingBox(Entity entityIn, double p_85094_2_, double p_85094_4_, double p_85094_6_, float p_85094_8_, float p_85094_9_)
    {
        ...
        RenderGlobal.drawBox(axisalignedbb1, 255, 255, 255, 255);
