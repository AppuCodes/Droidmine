...
public class GameOptions
{
    ...
    public GameOptions(ClientEngine mcIn, File p_i46326_2_)
    {
     ...
     */
    public void setOptionFloatValue(GameOptions.Options p_74304_1_, float p_74304_2_)
    {
        this.setOptionFloatValueOF(p_74304_1_, p_74304_2_);

        if (p_74304_1_ == GameOptions.Options.SENSITIVITY)
        {
            this.mouseSensitivity = p_74304_2_;
        }

        if (p_74304_1_ == GameOptions.Options.FOV)
        {
            this.fovSetting = p_74304_2_;
        }

        if (p_74304_1_ == GameOptions.Options.GAMMA)
        {
            this.gammaSetting = p_74304_2_;
        }

        if (p_74304_1_ == GameOptions.Options.CHAT_OPACITY)
        {
            this.chatOpacity = p_74304_2_;
            this.mc.ingameGUI.getChatGUI().refreshChat();
        }

        if (p_74304_1_ == GameOptions.Options.CHAT_HEIGHT_FOCUSED)
        {
            this.chatHeightFocused = p_74304_2_;
            this.mc.ingameGUI.getChatGUI().refreshChat();
        }

        if (p_74304_1_ == GameOptions.Options.CHAT_HEIGHT_UNFOCUSED)
        {
            this.chatHeightUnfocused = p_74304_2_;
            this.mc.ingameGUI.getChatGUI().refreshChat();
        }

        if (p_74304_1_ == GameOptions.Options.CHAT_WIDTH)
        {
            this.chatWidth = p_74304_2_;
            this.mc.ingameGUI.getChatGUI().refreshChat();
        }

        if (p_74304_1_ == GameOptions.Options.CHAT_SCALE)
        {
            this.chatScale = p_74304_2_;
            this.mc.ingameGUI.getChatGUI().refreshChat();
        }

        if (p_74304_1_ == GameOptions.Options.MIPMAP_LEVELS)
        {
        ...
        if (p_74304_1_ == GameOptions.Options.BLOCK_ALTERNATIVES)
        {
            this.allowBlockAlternatives = !this.allowBlockAlternatives;
            this.mc.renderGlobal.loadRenderers();
        }

        if (p_74304_1_ == GameOptions.Options.RENDER_DISTANCE)
        {
     ...
     */
    public void setOptionValue(GameOptions.Options p_74306_1_, int p_74306_2_)
    {
        this.setOptionValueOF(p_74306_1_, p_74306_2_);

        if (p_74306_1_ == GameOptions.Options.INVERT_MOUSE)
        {
            this.invertMouse = !this.invertMouse;
        }

        if (p_74306_1_ == GameOptions.Options.GUI_SCALE)
        {
            this.guiScale = this.guiScale + p_74306_2_ & 3;
            ScaledResolution.get().update(mc);
        }

        if (p_74306_1_ == GameOptions.Options.PARTICLES)
        {
            this.particleSetting = (this.particleSetting + p_74306_2_) % 3;
        }

        if (p_74306_1_ == GameOptions.Options.VIEW_BOBBING)
        {
            this.viewBobbing = !this.viewBobbing;
        }

        if (p_74306_1_ == GameOptions.Options.RENDER_CLOUDS)
        {
            this.clouds = (this.clouds + p_74306_2_) % 3;
        }

        if (p_74306_1_ == GameOptions.Options.FORCE_UNICODE_FONT)
        {
            this.forceUnicodeFont = !this.forceUnicodeFont;
            this.mc.fontRendererObj.setUnicodeFlag(this.mc.getLanguageManager().isCurrentLocaleUnicode() || this.forceUnicodeFont);
        }

        if (p_74306_1_ == GameOptions.Options.FBO_ENABLE)
        {
        ...
        if (p_74306_1_ == GameOptions.Options.GRAPHICS)
        {
        ...
        if (p_74306_1_ == GameOptions.Options.AMBIENT_OCCLUSION)
        {
            this.ambientOcclusion = (this.ambientOcclusion + p_74306_2_) % 3;
            this.mc.renderGlobal.loadRenderers();
        }

        if (p_74306_1_ == GameOptions.Options.CHAT_VISIBILITY)
        {
        ...
        if (p_74306_1_ == GameOptions.Options.STREAM_COMPRESSION)
        {
            this.streamCompression = (this.streamCompression + p_74306_2_) % 3;
        }

        if (p_74306_1_ == GameOptions.Options.STREAM_SEND_METADATA)
        {
            this.streamSendMetadata = !this.streamSendMetadata;
        }

        if (p_74306_1_ == GameOptions.Options.STREAM_CHAT_ENABLED)
        {
            this.streamChatEnabled = (this.streamChatEnabled + p_74306_2_) % 3;
        }

        if (p_74306_1_ == GameOptions.Options.STREAM_CHAT_USER_FILTER)
        {
            this.streamChatUserFilter = (this.streamChatUserFilter + p_74306_2_) % 3;
        }

        if (p_74306_1_ == GameOptions.Options.STREAM_MIC_TOGGLE_BEHAVIOR)
        {
            this.streamMicToggleBehavior = (this.streamMicToggleBehavior + p_74306_2_) % 2;
        }

        if (p_74306_1_ == GameOptions.Options.CHAT_COLOR)
        {
            this.chatColours = !this.chatColours;
        }

        if (p_74306_1_ == GameOptions.Options.CHAT_LINKS)
        {
            this.chatLinks = !this.chatLinks;
        }

        if (p_74306_1_ == GameOptions.Options.CHAT_LINKS_PROMPT)
        {
            this.chatLinksPrompt = !this.chatLinksPrompt;
        }

        if (p_74306_1_ == GameOptions.Options.SNOOPER_ENABLED)
        {
            this.snooperEnabled = !this.snooperEnabled;
        }

        if (p_74306_1_ == GameOptions.Options.TOUCHSCREEN)
        {
            this.touchscreen = !this.touchscreen;
        }

        if (p_74306_1_ == GameOptions.Options.USE_FULLSCREEN)
        {
        ...
        if (p_74306_1_ == GameOptions.Options.USE_VBO)
        {
            this.useVbo = !this.useVbo;
            this.mc.renderGlobal.loadRenderers();
        }

        if (p_74306_1_ == GameOptions.Options.BLOCK_ALTERNATIVES)
        {
            this.allowBlockAlternatives = !this.allowBlockAlternatives;
            this.mc.renderGlobal.loadRenderers();
        }

        if (p_74306_1_ == GameOptions.Options.REDUCED_DEBUG_INFO)
        {
            this.reducedDebugInfo = !this.reducedDebugInfo;
        }

        if (p_74306_1_ == GameOptions.Options.ENTITY_SHADOWS)
        {
    ...
    public float getOptionFloatValue(GameOptions.Options p_74296_1_)
    {
        return p_74296_1_ == GameOptions.Options.CLOUD_HEIGHT ? this.ofCloudsHeight : (p_74296_1_ == GameOptions.Options.AO_LEVEL ? this.ofAoLevel : (p_74296_1_ == GameOptions.Options.AA_LEVEL ? (float)this.ofAaLevel : (p_74296_1_ == GameOptions.Options.AF_LEVEL ? (float)this.ofAfLevel : (p_74296_1_ == GameOptions.Options.MIPMAP_TYPE ? (float)this.ofMipmapType : (p_74296_1_ == GameOptions.Options.FRAMERATE_LIMIT ? 0.0F : (p_74296_1_ == GameOptions.Options.FOV ? this.fovSetting : (p_74296_1_ == GameOptions.Options.GAMMA ? this.gammaSetting : (p_74296_1_ == GameOptions.Options.SATURATION ? this.saturation : (p_74296_1_ == GameOptions.Options.SENSITIVITY ? this.mouseSensitivity : (p_74296_1_ == GameOptions.Options.CHAT_OPACITY ? this.chatOpacity : (p_74296_1_ == GameOptions.Options.CHAT_HEIGHT_FOCUSED ? this.chatHeightFocused : (p_74296_1_ == GameOptions.Options.CHAT_HEIGHT_UNFOCUSED ? this.chatHeightUnfocused : (p_74296_1_ == GameOptions.Options.CHAT_SCALE ? this.chatScale : (p_74296_1_ == GameOptions.Options.CHAT_WIDTH ? this.chatWidth : (p_74296_1_ == GameOptions.Options.FRAMERATE_LIMIT ? 0.0F : (p_74296_1_ == GameOptions.Options.MIPMAP_LEVELS ? (float)this.mipmapLevels : (p_74296_1_ == GameOptions.Options.RENDER_DISTANCE ? (float)this.renderDistanceChunks : (p_74296_1_ == GameOptions.Options.STREAM_BYTES_PER_PIXEL ? this.streamBytesPerPixel : (p_74296_1_ == GameOptions.Options.STREAM_VOLUME_MIC ? this.streamMicVolume : (p_74296_1_ == GameOptions.Options.STREAM_VOLUME_SYSTEM ? this.streamGameVolume : (p_74296_1_ == GameOptions.Options.STREAM_KBPS ? this.streamKbps : (p_74296_1_ == GameOptions.Options.STREAM_FPS ? this.streamFps : 0.0F))))))))))))))))))))));
    }

    public boolean getOptionOrdinalValue(GameOptions.Options p_74308_1_)
    {
        switch (GameOptions.options$2.field_151477_a[p_74308_1_.ordinal()])
        {
            case 1:
     ...
     * Gets a key binding.
     */
    public String getKeyBinding(GameOptions.Options p_74297_1_)
    {
        ...
        else
        {
            ...
            if (p_74297_1_.getEnumFloat())
            {
                ...
                return p_74297_1_ == GameOptions.Options.SENSITIVITY ? (f == 0.0F ? s1 + I18n.format("options.sensitivity.min", new Object[0]) : (f == 1.0F ? s1 + I18n.format("options.sensitivity.max", new Object[0]) : s1 + (int)(f * 200.0F) + "%")) : (p_74297_1_ == GameOptions.Options.FOV ? (f1 == 70.0F ? s1 + I18n.format("options.fov.min", new Object[0]) : (f1 == 110.0F ? s1 + I18n.format("options.fov.max", new Object[0]) : s1 + (int)f1)) : (p_74297_1_ == GameOptions.Options.FRAMERATE_LIMIT ? (f1 == p_74297_1_.valueMax ? s1 + I18n.format("options.framerateLimit.max", new Object[0]) : s1 + (int)f1 + " fps") : (p_74297_1_ == GameOptions.Options.RENDER_CLOUDS ? (f1 == p_74297_1_.valueMin ? s1 + I18n.format("options.cloudHeight.min", new Object[0]) : s1 + ((int)f1 + 128)) : (p_74297_1_ == GameOptions.Options.GAMMA ? (f == 0.0F ? s1 + I18n.format("options.gamma.min", new Object[0]) : (f == 1.0F ? s1 + I18n.format("options.gamma.max", new Object[0]) : s1 + "+" + (int)(f * 100.0F) + "%")) : (p_74297_1_ == GameOptions.Options.SATURATION ? s1 + (int)(f * 400.0F) + "%" : (p_74297_1_ == GameOptions.Options.CHAT_OPACITY ? s1 + (int)(f * 90.0F + 10.0F) + "%" : (p_74297_1_ == GameOptions.Options.CHAT_HEIGHT_UNFOCUSED ? s1 + GuiNewChat.calculateChatboxHeight(f) + "px" : (p_74297_1_ == GameOptions.Options.CHAT_HEIGHT_FOCUSED ? s1 + GuiNewChat.calculateChatboxHeight(f) + "px" : (p_74297_1_ == GameOptions.Options.CHAT_WIDTH ? s1 + GuiNewChat.calculateChatboxWidth(f) + "px" : (p_74297_1_ == GameOptions.Options.RENDER_DISTANCE ? s1 + (int)f1 + " chunks" : (p_74297_1_ == GameOptions.Options.MIPMAP_LEVELS ? (f1 == 0.0F ? s1 + I18n.format("options.off", new Object[0]) : s1 + (int)f1) : (p_74297_1_ == GameOptions.Options.STREAM_FPS ? s1 + " fps" : (p_74297_1_ == GameOptions.Options.STREAM_KBPS ? s1 + " Kbps" : (p_74297_1_ == GameOptions.Options.STREAM_BYTES_PER_PIXEL ? s1 : (f == 0.0F ? s1 + I18n.format("options.off", new Object[0]) : s1 + (int)(f * 100.0F) + "%")))))))))))))));
            }
    ...
    public void sendSettingsToServer()
    {
        if (this.mc.player != null)
        {
            ...
            this.mc.player.sendQueue.sendPacket(new C15PacketClientSettings(this.language, this.renderDistanceChunks, this.chatVisibility, this.chatColours, i));
        }
    }
    ...
    private void setOptionFloatValueOF(GameOptions.Options p_setOptionFloatValueOF_1_, float p_setOptionFloatValueOF_2_)
    {
        if (p_setOptionFloatValueOF_1_ == GameOptions.Options.CLOUD_HEIGHT)
        {
            this.ofCloudsHeight = p_setOptionFloatValueOF_2_;
            this.mc.renderGlobal.resetClouds();
        }

        if (p_setOptionFloatValueOF_1_ == GameOptions.Options.AO_LEVEL)
        {
            this.ofAoLevel = p_setOptionFloatValueOF_2_;
            this.mc.renderGlobal.loadRenderers();
        }

        if (p_setOptionFloatValueOF_1_ == GameOptions.Options.AA_LEVEL)
        {
    ...
    private void setOptionValueOF(GameOptions.Options p_setOptionValueOF_1_, int p_setOptionValueOF_2_)
    {
        if (p_setOptionValueOF_1_ == GameOptions.Options.FOG_FANCY)
        {
        ...
        if (p_setOptionValueOF_1_ == GameOptions.Options.FOG_START)
        {
        ...
        if (p_setOptionValueOF_1_ == GameOptions.Options.SMOOTH_FPS)
        {
        ...
        if (p_setOptionValueOF_1_ == GameOptions.Options.TREES)
        {
            this.ofTrees = nextValue(this.ofTrees, OF_TREES_VALUES);
            this.mc.renderGlobal.loadRenderers();
        }

        if (p_setOptionValueOF_1_ == GameOptions.Options.DROPPED_ITEMS)
        {
            ++this.ofDroppedItems;
        ...
        if (p_setOptionValueOF_1_ == GameOptions.Options.RAIN)
        {
            ++this.ofRain;
        ...
        if (p_setOptionValueOF_1_ == GameOptions.Options.ANIMATED_WATER)
        {
        ...
        if (p_setOptionValueOF_1_ == GameOptions.Options.ANIMATED_LAVA)
        {
            ++this.ofAnimatedLava;
        ...
        if (p_setOptionValueOF_1_ == GameOptions.Options.ANIMATED_FIRE)
        {
            this.ofAnimatedFire = !this.ofAnimatedFire;
        }

        if (p_setOptionValueOF_1_ == GameOptions.Options.ANIMATED_PORTAL)
        {
            this.ofAnimatedPortal = !this.ofAnimatedPortal;
        }

        if (p_setOptionValueOF_1_ == GameOptions.Options.ANIMATED_REDSTONE)
        {
            this.ofAnimatedRedstone = !this.ofAnimatedRedstone;
        }

        if (p_setOptionValueOF_1_ == GameOptions.Options.ANIMATED_EXPLOSION)
        {
            this.ofAnimatedExplosion = !this.ofAnimatedExplosion;
        }

        if (p_setOptionValueOF_1_ == GameOptions.Options.ANIMATED_FLAME)
        {
            this.ofAnimatedFlame = !this.ofAnimatedFlame;
        }

        if (p_setOptionValueOF_1_ == GameOptions.Options.ANIMATED_SMOKE)
        {
            this.ofAnimatedSmoke = !this.ofAnimatedSmoke;
        }

        if (p_setOptionValueOF_1_ == GameOptions.Options.VOID_PARTICLES)
        {
            this.ofVoidParticles = !this.ofVoidParticles;
        }

        if (p_setOptionValueOF_1_ == GameOptions.Options.WATER_PARTICLES)
        {
            this.ofWaterParticles = !this.ofWaterParticles;
        }

        if (p_setOptionValueOF_1_ == GameOptions.Options.PORTAL_PARTICLES)
        {
            this.ofPortalParticles = !this.ofPortalParticles;
        }

        if (p_setOptionValueOF_1_ == GameOptions.Options.POTION_PARTICLES)
        {
            this.ofPotionParticles = !this.ofPotionParticles;
        }

        if (p_setOptionValueOF_1_ == GameOptions.Options.FIREWORK_PARTICLES)
        {
            this.ofFireworkParticles = !this.ofFireworkParticles;
        }

        if (p_setOptionValueOF_1_ == GameOptions.Options.DRIPPING_WATER_LAVA)
        {
            this.ofDrippingWaterLava = !this.ofDrippingWaterLava;
        }

        if (p_setOptionValueOF_1_ == GameOptions.Options.ANIMATED_TERRAIN)
        {
            this.ofAnimatedTerrain = !this.ofAnimatedTerrain;
        }

        if (p_setOptionValueOF_1_ == GameOptions.Options.ANIMATED_TEXTURES)
        {
            this.ofAnimatedTextures = !this.ofAnimatedTextures;
        }

        if (p_setOptionValueOF_1_ == GameOptions.Options.RAIN_SPLASH)
        {
            this.ofRainSplash = !this.ofRainSplash;
        }

        if (p_setOptionValueOF_1_ == GameOptions.Options.LAGOMETER)
        {
            this.ofLagometer = !this.ofLagometer;
        }

        if (p_setOptionValueOF_1_ == GameOptions.Options.SHOW_FPS)
        {
            this.ofShowFps = !this.ofShowFps;
        }

        if (p_setOptionValueOF_1_ == GameOptions.Options.AUTOSAVE_TICKS)
        {
        ...
        if (p_setOptionValueOF_1_ == GameOptions.Options.BETTER_GRASS)
        {
            ++this.ofBetterGrass;
        ...
        if (p_setOptionValueOF_1_ == GameOptions.Options.CONNECTED_TEXTURES)
        {
        ...
        if (p_setOptionValueOF_1_ == GameOptions.Options.WEATHER)
        {
            this.ofWeather = !this.ofWeather;
        }

        if (p_setOptionValueOF_1_ == GameOptions.Options.SKY)
        {
            this.ofSky = !this.ofSky;
        }

        if (p_setOptionValueOF_1_ == GameOptions.Options.STARS)
        {
            this.ofStars = !this.ofStars;
        }

        if (p_setOptionValueOF_1_ == GameOptions.Options.SUN_MOON)
        {
            this.ofSunMoon = !this.ofSunMoon;
        }

        if (p_setOptionValueOF_1_ == GameOptions.Options.VIGNETTE)
        {
            ++this.ofVignette;
        ...
        if (p_setOptionValueOF_1_ == GameOptions.Options.CHUNK_UPDATES)
        {
            ++this.ofChunkUpdates;
        ...
        if (p_setOptionValueOF_1_ == GameOptions.Options.CHUNK_UPDATES_DYNAMIC)
        {
            this.ofChunkUpdatesDynamic = !this.ofChunkUpdatesDynamic;
        }

        if (p_setOptionValueOF_1_ == GameOptions.Options.TIME)
        {
            ++this.ofTime;
        ...
        if (p_setOptionValueOF_1_ == GameOptions.Options.CLEAR_WATER)
        {
            this.ofClearWater = !this.ofClearWater;
            this.updateWaterOpacity();
        }

        if (p_setOptionValueOF_1_ == GameOptions.Options.PROFILER)
        {
            this.ofProfiler = !this.ofProfiler;
        }

        if (p_setOptionValueOF_1_ == GameOptions.Options.BETTER_SNOW)
        {
            this.ofBetterSnow = !this.ofBetterSnow;
            this.mc.renderGlobal.loadRenderers();
        }

        if (p_setOptionValueOF_1_ == GameOptions.Options.SWAMP_COLORS)
        {
        ...
        if (p_setOptionValueOF_1_ == GameOptions.Options.RANDOM_MOBS)
        {
            this.ofRandomMobs = !this.ofRandomMobs;
            RandomMobs.resetTextures();
        }

        if (p_setOptionValueOF_1_ == GameOptions.Options.SMOOTH_BIOMES)
        {
        ...
        if (p_setOptionValueOF_1_ == GameOptions.Options.CUSTOM_ITEMS)
        {
            this.ofCustomItems = !this.ofCustomItems;
            this.mc.refreshResources();
        }

        if (p_setOptionValueOF_1_ == GameOptions.Options.CUSTOM_SKY)
        {
            this.ofCustomSky = !this.ofCustomSky;
            CustomSky.update();
        }

        if (p_setOptionValueOF_1_ == GameOptions.Options.SHOW_CAPES)
        {
        ...
        if (p_setOptionValueOF_1_ == GameOptions.Options.FAST_MATH)
        {
        ...
        if (p_setOptionValueOF_1_ == GameOptions.Options.DYNAMIC_FOV)
        {
            this.ofDynamicFov = !this.ofDynamicFov;
        }

        if (p_setOptionValueOF_1_ == GameOptions.Options.DYNAMIC_LIGHTS)
        {
            this.ofDynamicLights = nextValue(this.ofDynamicLights, OF_DYNAMIC_LIGHTS);
            DynamicLights.removeLights(this.mc.renderGlobal);
        }

        if (p_setOptionValueOF_1_ == GameOptions.Options.HELD_ITEM_TOOLTIPS)
        {
            this.heldItemTooltips = !this.heldItemTooltips;
        }
    }

    private String getKeyBindingOF(GameOptions.Options p_getKeyBindingOF_1_)
    {
        String s = I18n.format(p_getKeyBindingOF_1_.getEnumString(), new Object[0]) + ": ";

        if (p_getKeyBindingOF_1_ == GameOptions.Options.RENDER_DISTANCE)
        {
        ...
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.FOG_FANCY)
        {
            switch (this.ofFogType)
            {
                case 1:
        ...
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.FOG_START)
        {
            return s + this.ofFogStart;
        }
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.MIPMAP_TYPE)
        {
        ...
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.SMOOTH_FPS)
        {
            return this.ofSmoothFps ? s + Lang.getOn() : s + Lang.getOff();
        }
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.SMOOTH_WORLD)
        {
            return this.ofSmoothWorld ? s + Lang.getOn() : s + Lang.getOff();
        }
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.CLOUDS)
        {
        ...
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.TREES)
        {
            switch (this.ofTrees)
            {
                case 1:
        ...
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.DROPPED_ITEMS)
        {
        ...
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.RAIN)
        {
            switch (this.ofRain)
            {
                case 1:
        ...
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.ANIMATED_WATER)
        {
        ...
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.ANIMATED_LAVA)
        {
        ...
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.ANIMATED_FIRE)
        {
            return this.ofAnimatedFire ? s + Lang.getOn() : s + Lang.getOff();
        }
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.ANIMATED_PORTAL)
        {
            return this.ofAnimatedPortal ? s + Lang.getOn() : s + Lang.getOff();
        }
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.ANIMATED_REDSTONE)
        {
            return this.ofAnimatedRedstone ? s + Lang.getOn() : s + Lang.getOff();
        }
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.ANIMATED_EXPLOSION)
        {
            return this.ofAnimatedExplosion ? s + Lang.getOn() : s + Lang.getOff();
        }
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.ANIMATED_FLAME)
        {
            return this.ofAnimatedFlame ? s + Lang.getOn() : s + Lang.getOff();
        }
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.ANIMATED_SMOKE)
        {
            return this.ofAnimatedSmoke ? s + Lang.getOn() : s + Lang.getOff();
        }
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.VOID_PARTICLES)
        {
            return this.ofVoidParticles ? s + Lang.getOn() : s + Lang.getOff();
        }
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.WATER_PARTICLES)
        {
            return this.ofWaterParticles ? s + Lang.getOn() : s + Lang.getOff();
        }
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.PORTAL_PARTICLES)
        {
            return this.ofPortalParticles ? s + Lang.getOn() : s + Lang.getOff();
        }
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.POTION_PARTICLES)
        {
            return this.ofPotionParticles ? s + Lang.getOn() : s + Lang.getOff();
        }
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.FIREWORK_PARTICLES)
        {
            return this.ofFireworkParticles ? s + Lang.getOn() : s + Lang.getOff();
        }
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.DRIPPING_WATER_LAVA)
        {
            return this.ofDrippingWaterLava ? s + Lang.getOn() : s + Lang.getOff();
        }
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.ANIMATED_TERRAIN)
        {
            return this.ofAnimatedTerrain ? s + Lang.getOn() : s + Lang.getOff();
        }
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.ANIMATED_TEXTURES)
        {
            return this.ofAnimatedTextures ? s + Lang.getOn() : s + Lang.getOff();
        }
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.RAIN_SPLASH)
        {
            return this.ofRainSplash ? s + Lang.getOn() : s + Lang.getOff();
        }
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.LAGOMETER)
        {
            return this.ofLagometer ? s + Lang.getOn() : s + Lang.getOff();
        }
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.SHOW_FPS)
        {
            return this.ofShowFps ? s + Lang.getOn() : s + Lang.getOff();
        }
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.AUTOSAVE_TICKS)
        {
        ...
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.BETTER_GRASS)
        {
        ...
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.CONNECTED_TEXTURES)
        {
        ...
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.WEATHER)
        {
            return this.ofWeather ? s + Lang.getOn() : s + Lang.getOff();
        }
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.SKY)
        {
            return this.ofSky ? s + Lang.getOn() : s + Lang.getOff();
        }
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.STARS)
        {
            return this.ofStars ? s + Lang.getOn() : s + Lang.getOff();
        }
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.SUN_MOON)
        {
            return this.ofSunMoon ? s + Lang.getOn() : s + Lang.getOff();
        }
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.VIGNETTE)
        {
        ...
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.CHUNK_UPDATES)
        {
            return s + this.ofChunkUpdates;
        }
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.CHUNK_UPDATES_DYNAMIC)
        {
            return this.ofChunkUpdatesDynamic ? s + Lang.getOn() : s + Lang.getOff();
        }
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.TIME)
        {
        ...
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.CLEAR_WATER)
        {
            return this.ofClearWater ? s + Lang.getOn() : s + Lang.getOff();
        }
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.AA_LEVEL)
        {
            String s3 = "";
        ...
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.AF_LEVEL)
        {
            return this.ofAfLevel == 1 ? s + Lang.getOff() : s + this.ofAfLevel;
        }
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.PROFILER)
        {
            return this.ofProfiler ? s + Lang.getOn() : s + Lang.getOff();
        }
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.BETTER_SNOW)
        {
            return this.ofBetterSnow ? s + Lang.getOn() : s + Lang.getOff();
        }
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.SWAMP_COLORS)
        {
            return this.ofSwampColors ? s + Lang.getOn() : s + Lang.getOff();
        }
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.RANDOM_MOBS)
        {
            return this.ofRandomMobs ? s + Lang.getOn() : s + Lang.getOff();
        }
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.SMOOTH_BIOMES)
        {
            return this.ofSmoothBiomes ? s + Lang.getOn() : s + Lang.getOff();
        }
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.CUSTOM_FONTS)
        {
            return this.ofCustomFonts ? s + Lang.getOn() : s + Lang.getOff();
        }
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.CUSTOM_COLORS)
        {
            return this.ofCustomColors ? s + Lang.getOn() : s + Lang.getOff();
        }
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.CUSTOM_SKY)
        {
            return this.ofCustomSky ? s + Lang.getOn() : s + Lang.getOff();
        }
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.SHOW_CAPES)
        {
            return this.ofShowCapes ? s + Lang.getOn() : s + Lang.getOff();
        }
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.CUSTOM_ITEMS)
        {
            return this.ofCustomItems ? s + Lang.getOn() : s + Lang.getOff();
        }
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.NATURAL_TEXTURES)
        {
            return this.ofNaturalTextures ? s + Lang.getOn() : s + Lang.getOff();
        }
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.FAST_MATH)
        {
            return this.ofFastMath ? s + Lang.getOn() : s + Lang.getOff();
        }
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.FAST_RENDER)
        {
            return this.ofFastRender ? s + Lang.getOn() : s + Lang.getOff();
        }
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.TRANSLUCENT_BLOCKS)
        {
            return this.ofTranslucentBlocks == 1 ? s + Lang.getFast() : (this.ofTranslucentBlocks == 2 ? s + Lang.getFancy() : s + Lang.getDefault());
        }
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.LAZY_CHUNK_LOADING)
        {
            return this.ofLazyChunkLoading ? s + Lang.getOn() : s + Lang.getOff();
        }
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.DYNAMIC_FOV)
        {
            return this.ofDynamicFov ? s + Lang.getOn() : s + Lang.getOff();
        }
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.DYNAMIC_LIGHTS)
        {
            int k = indexOf(this.ofDynamicLights, OF_DYNAMIC_LIGHTS);
            return s + getTranslation(KEYS_DYNAMIC_LIGHTS, k);
        }
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.FULLSCREEN_MODE)
        {
            return this.ofFullscreenMode.equals("Default") ? s + Lang.getDefault() : s + this.ofFullscreenMode;
        }
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.HELD_ITEM_TOOLTIPS)
        {
            return this.heldItemTooltips ? s + Lang.getOn() : s + Lang.getOff();
        }
        else if (p_getKeyBindingOF_1_ == GameOptions.Options.FRAMERATE_LIMIT)
        {
    ...
    static final class options$2
    {
        static final int[] field_151477_a = new int[GameOptions.Options.values().length];
        ...
        static
        {
            try
            {
                field_151477_a[GameOptions.Options.INVERT_MOUSE.ordinal()] = 1;
            }
            ...
            try
            {
                field_151477_a[GameOptions.Options.VIEW_BOBBING.ordinal()] = 2;
            }
            ...
            try
            {
                field_151477_a[GameOptions.Options.ANAGLYPH.ordinal()] = 3;
            }
            ...
            try
            {
                field_151477_a[GameOptions.Options.FBO_ENABLE.ordinal()] = 4;
            }
            ...
            try
            {
                field_151477_a[GameOptions.Options.CHAT_COLOR.ordinal()] = 5;
            }
            ...
            try
            {
                field_151477_a[GameOptions.Options.CHAT_LINKS.ordinal()] = 6;
            }
            ...
            try
            {
                field_151477_a[GameOptions.Options.CHAT_LINKS_PROMPT.ordinal()] = 7;
            }
            ...
            try
            {
                field_151477_a[GameOptions.Options.SNOOPER_ENABLED.ordinal()] = 8;
            }
            ...
            try
            {
                field_151477_a[GameOptions.Options.USE_FULLSCREEN.ordinal()] = 9;
            }
            ...
            try
            {
                field_151477_a[GameOptions.Options.ENABLE_VSYNC.ordinal()] = 10;
            }
            ...
            try
            {
                field_151477_a[GameOptions.Options.USE_VBO.ordinal()] = 11;
            }
            ...
            try
            {
                field_151477_a[GameOptions.Options.TOUCHSCREEN.ordinal()] = 12;
            }
            ...
            try
            {
                field_151477_a[GameOptions.Options.STREAM_SEND_METADATA.ordinal()] = 13;
            }
            ...
            try
            {
                field_151477_a[GameOptions.Options.FORCE_UNICODE_FONT.ordinal()] = 14;
            }
            ...
            try
            {
                field_151477_a[GameOptions.Options.BLOCK_ALTERNATIVES.ordinal()] = 15;
            }
            ...
            try
            {
                field_151477_a[GameOptions.Options.REDUCED_DEBUG_INFO.ordinal()] = 16;
            }
            ...
            try
            {
                field_151477_a[GameOptions.Options.ENTITY_SHADOWS.ordinal()] = 17;
            }
