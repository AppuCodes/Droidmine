...
public class GuiPlayerTabOverlay extends Gui
{
    ...
    public GuiPlayerTabOverlay(ClientEngine mcIn, GuiIngame guiIngameIn)
    {
        this.mc = mcIn;
    ...
    public void updatePlayerList(boolean willBeRendered)
    {
        ...
        {
            this.lastTimeOpened = ClientEngine.getSystemTime();
        }
    ...
    public void renderPlayerlist(int width, Scoreboard scoreboardIn, ScoreObjective scoreObjectiveIn)
    {
        ...
        int k1 = BossStatus.bossName != null && BossStatus.statusBarTime > 0 && !BossStatus.bossName.isEmpty() ? 20 : 0;
        int l1 = i1 * j4 + (j4 - 1) * 5;
        ...
        if (list1 != null)
        {
            drawRect(width / 2 - l1 / 2 - 1, k1, width / 2 + l1 / 2 + 1, k1 + list1.size() * this.mc.fontRendererObj.FONT_HEIGHT, Integer.MIN_VALUE);
    ...
    private void drawScoreboardValues(ScoreObjective p_175247_1_, int p_175247_2_, String p_175247_3_, int p_175247_4_, int p_175247_5_, NetworkPlayerInfo p_175247_6_)
    {
        ...
        if (p_175247_1_.getRenderType() == IScoreObjectiveCriteria.EnumRenderType.HEARTS)
        {
            ...
            if (this.lastTimeOpened == p_175247_6_.func_178855_p())
            {
                ...
                {
                    p_175247_6_.func_178846_a(ClientEngine.getSystemTime());
            ...
            if (ClientEngine.getSystemTime() - p_175247_6_.func_178847_n() > 1000L || this.lastTimeOpened != p_175247_6_.func_178855_p())
            {
