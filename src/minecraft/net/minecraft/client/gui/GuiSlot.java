...
public abstract class GuiSlot
{
    ...
    public GuiSlot(ClientEngine mcIn, int width, int height, int topIn, int bottomIn, int slotHeightIn)
    {
        this.mc = mcIn;
        this.width = width;
        this.height = height;
            ...
            if (Mouse.get().isButtonDown(0) && this.getEnabled())
            {
                if (this.initialClickY == -1)
                {
                    ...
                    if (this.mouseY >= this.top && this.mouseY <= this.bottom)
                    {
                        ...
                        {
                            boolean flag = i1 == this.selectedElement && ClientEngine.getSystemTime() - this.lastClicked < 250L;
                            this.elementClicked(i1, flag, this.mouseX, this.mouseY);
                            this.selectedElement = i1;
                            this.lastClicked = ClientEngine.getSystemTime();
                        }
