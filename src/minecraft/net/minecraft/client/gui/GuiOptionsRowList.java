...
public class GuiOptionsRowList extends GuiListExtended
{
    ...
    public GuiOptionsRowList(ClientEngine mcIn, int p_i45015_2_, int p_i45015_3_, int p_i45015_4_, int p_i45015_5_, int p_i45015_6_, GameOptions.Options... p_i45015_7_)
    {
        ...
        {
            GameOptions.Options options$options = p_i45015_7_[i];
    ...
    private GuiButton func_148182_a(ClientEngine mcIn, int p_148182_2_, int p_148182_3_, GameOptions.Options p_148182_4_)
    {
        if (p_148182_4_ == null)
        {
            return null;
    ...
    public static class Row implements GuiListExtended.IGuiListEntry
    {
        ...
        public boolean mousePressed(int slotIndex, int p_148278_2_, int p_148278_3_, int p_148278_4_, int p_148278_5_, int p_148278_6_)
        {
            if (this.field_148323_b.mousePressed(this.field_148325_a, p_148278_2_, p_148278_3_))
            {
                ...
                {
                    this.field_148325_a.options.setOptionValue(((GuiOptionButton)this.field_148323_b).returnEnumOptions(), 1);
                    this.field_148323_b.displayString = this.field_148325_a.options.getKeyBinding(GameOptions.Options.getEnumOptions(this.field_148323_b.id));
                }
            ...
            else if (this.field_148324_c != null && this.field_148324_c.mousePressed(this.field_148325_a, p_148278_2_, p_148278_3_))
            {
                ...
                {
                    this.field_148325_a.options.setOptionValue(((GuiOptionButton)this.field_148324_c).returnEnumOptions(), 1);
                    this.field_148324_c.displayString = this.field_148325_a.options.getKeyBinding(GameOptions.Options.getEnumOptions(this.field_148324_c.id));
                }
