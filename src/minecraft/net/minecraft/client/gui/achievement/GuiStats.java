...
public class GuiStats extends GuiScreen implements IProgressMeter
{
    ...
    abstract class Stats extends GuiSlot
    {
        ...
        protected Stats(ClientEngine mcIn)
        {
    ...
    {
        public StatsBlock(ClientEngine mcIn)
        {
            super(mcIn);
    ...
    {
        public StatsGeneral(ClientEngine mcIn)
        {
    ...
    {
        public StatsItem(ClientEngine mcIn)
        {
            super(mcIn);
            this.statsHolder = Lists.<StatCrafting>newArrayList();
    ...
    class StatsMobsList extends GuiSlot
    {
        ...
        public StatsMobsList(ClientEngine mcIn)
        {
