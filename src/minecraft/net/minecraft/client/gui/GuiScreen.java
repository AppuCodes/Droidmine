...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback
{
     ...
     * Container.validate()
     */
    public void setWorldAndResolution(ClientEngine mc, int width, int height)
    {
        this.mc = mc;
    ...
    public void handleMouseInput() throws IOException
    {
        ...
        if (Mouse.getEventButtonState())
        {
            ...
            this.eventButton = k;
            this.lastMouseEvent = ClientEngine.getSystemTime();
        ...
        {
            long l = ClientEngine.getSystemTime() - this.lastMouseEvent;
    ...
    public void drawWorldBackground(int tint)
    {
        ...
        {
            this.drawRect(0, 0, this.width, this.height, -1358954496);
        }
        else
        {
     ...
     */
    public void onResize(ClientEngine mcIn, int p_175273_2_, int p_175273_3_)
    {
