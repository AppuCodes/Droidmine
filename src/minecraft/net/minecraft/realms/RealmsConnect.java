...
//                    }
//
//                    RealmsConnect.this.connection = NetworkManager.create(inetaddress, p_connect_2_, ClientEngine.get().options.func_181148_f());
//
//                    if (RealmsConnect.this.aborted)
//                    {
//                        return;
//                    }
//
//                    RealmsConnect.this.connection.setNetHandler(new NetHandlerLoginClient(RealmsConnect.this.connection, ClientEngine.get(), RealmsConnect.this.onlineScreen.getProxy()));
//
//                    if (RealmsConnect.this.aborted)
//                    {
//                        return;
...
//                    }
//
//                    RealmsConnect.this.connection.sendPacket(new C00PacketLoginStart(ClientEngine.get().getSession().profile()));
//                }
